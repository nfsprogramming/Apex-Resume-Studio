    ...
    def simulate_scan(self, resume_text: str, company: str) -> dict:
        ...
        if company == "Amazon":
            ...
            if lp_count >= 2:
                ...
                company_feedback.append("Amazon heavily weighs Leadership Principles. explicitly mention outcomes that map to them.")
            ...
            if "scale" in text_lower or "distributed" in text_lower or "petabyte" in text_lower:
                ...
                company_feedback.append("Google looks for 'scalability' and complexity. Highlight system design work.")
            ...
            if "design" in text_lower or "user experience" in text_lower or "quality" in text_lower:
                ...
                company_feedback.append("Apple values 'Obsession with Detail' and 'UX'. Highlight your product sense.")
