...
class JDFetcher:
    ...
    def fetch_from_url(self, url: str) -> str:
        ...
        if platform == "LinkedIn" and "/in/" in url:
            raise ValueError("You entered a LinkedIn Profile URL, not a Job Posting URL. Please use a Job URL, for example: https://www.linkedin.com/jobs/view/...")
        ...
        try:
            ...
            if "999" in str(e):
                raise Exception("LinkedIn blocked the request (Status 999). This is common with automated tools. Please copy and paste the text manually.")
            else:
                raise Exception(f"Error fetching JD from {platform}: {str(e)}")
