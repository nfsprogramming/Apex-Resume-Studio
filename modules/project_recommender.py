...
class ProjectRecommender:
    ...
    def get_recommendations(self, missing_skills: List[str]) -> List[Dict]:
        ...
        response = ai_engine(prompt, system_message="You are a Senior Engineering Manager mentoring a junior. Return JSON only.")
        ...
        try:
            ...
            if start != -1 and end != -1:
                ...
                # Ensure the parsed response is a list of dictionaries (not strings)
