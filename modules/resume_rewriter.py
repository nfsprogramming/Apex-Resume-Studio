...
class ResumeRewriter:
    ...
    def rewrite_section(self, section_text: str, target_role: str, tone: str = "Professional") -> str:
        ...
        return ai_engine(prompt, system_message="You are a professional resume writer.")
    ...
    def generate_tailored_summary(self, resume_text: str, jd_text: str) -> str:
        ...
        return ai_engine(prompt, system_message="You are a clear and persuasive career coach.")
